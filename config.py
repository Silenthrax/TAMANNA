...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Silenthrax/TAMANNA",)
...
autoclean = []
confirmer = {}
START_IMG_URL = getenv("START_IMG_URL", "https://files.catbox.moe/5cp1u6.jpg")
PING_IMG_URL = getenv("PING_IMG_URL", "https://files.catbox.moe/k2zqfo.jpg")
